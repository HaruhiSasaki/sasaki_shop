...
public class MainController {
	...
	public @ResponseBody String addNewProduct_master(@RequestParam String product, @RequestParam String shohinname,
			@RequestParam String torokusya, @RequestParam String torokupg,
			@RequestParam Integer torokudate, @RequestParam String kosinsya, @RequestParam Integer kosindate,
